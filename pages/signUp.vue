<template>
    <div class="flex flex-col h-screen justify-center items-center">
        <div class="m-4 flex flex-col border border-[#3c3c3c] items-center bg-[#171717] w-96 p-4 rounded-lg h-98">
            ...
            <div class="max-w-sm mb-4">
                <div class="relative">
                    <input @keyup.enter="requestSignUp" v-model="confirmPassword" :type=showConfirmPassword class="w-60 h-14 py-2.5 sm:py-3 ps-4 pe-10 block border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-[#262626] dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Confirm password">
